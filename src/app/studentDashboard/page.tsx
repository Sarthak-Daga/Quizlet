...
// QuizCard component
function QuizCard({ quiz, actionText, actionHref, actionColor, additionalInfo }: { 
  quiz: {
    id: string;
    title: string;
    category: string;
...
// PerformanceChart component
function PerformanceChart({ data }: { data: { date: string; score: number }[] }) {
...
function QuizListItem({ title, date, questions }: { 
  title: string, 
  date: string, 
  questions: string 
}) {
...
function StudentListItem({ name, score }: { 
  name: string, 
  score: string 
}) {
  return (
